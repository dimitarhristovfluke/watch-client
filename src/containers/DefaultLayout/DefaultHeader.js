...
import logo from "../../assets/graphics/Emaint-Fluke-Logo-1-regular.png";
import sygnet from "../../assets/graphics/emaint-favico-16x16.png";
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <AppNavbarBrand
          full={{ src: logo, height: 35, alt: "eMaint Logo" }}
          minimized={{ src: sygnet, width: 30, height: 30, alt: "eMaint Logo" }}
        />
